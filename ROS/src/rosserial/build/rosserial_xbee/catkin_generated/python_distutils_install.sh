...
echo_and_run cd "/home/tripp/Workspaces/src/rosserial/src/rosserial_xbee"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/tripp/Workspaces/src/rosserial/src/rosserial_xbee/setup.py" \
    build --build-base "/home/tripp/Workspaces/src/rosserial/build/rosserial_xbee" \
    install \
    $DESTDIR_ARG \
