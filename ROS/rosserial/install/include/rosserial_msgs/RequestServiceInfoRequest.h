...
bool operator==(const ::rosserial_msgs::RequestServiceInfoRequest_<ContainerAllocator1> & lhs, const ::rosserial_msgs::RequestServiceInfoRequest_<ContainerAllocator2> & rhs)
{
