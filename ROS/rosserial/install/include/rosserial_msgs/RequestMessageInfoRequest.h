...
bool operator==(const ::rosserial_msgs::RequestMessageInfoRequest_<ContainerAllocator1> & lhs, const ::rosserial_msgs::RequestMessageInfoRequest_<ContainerAllocator2> & rhs)
{
...
struct Definition< ::rosserial_msgs::RequestMessageInfoRequest_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# Full message datatype, eg \"std_msgs/String\"\n"
"string type\n"
;
  }
