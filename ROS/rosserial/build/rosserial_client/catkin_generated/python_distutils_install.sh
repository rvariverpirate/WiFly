...
echo_and_run cd "/home/tripp/Workspaces/src/rosserial/src/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/tripp/Workspaces/src/rosserial/src/rosserial_client/setup.py" \
    build --build-base "/home/tripp/Workspaces/src/rosserial/build/rosserial_client" \
    install \
    $DESTDIR_ARG \
