...
echo_and_run cd "/home/tripp/Workspaces/src/rosserial/src/rosserial_vex_v5"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/tripp/Workspaces/src/rosserial/src/rosserial_vex_v5/setup.py" \
    build --build-base "/home/tripp/Workspaces/src/rosserial/build/rosserial_vex_v5" \
    install \
    $DESTDIR_ARG \
