#ifndef _ROS_rosserial_msgs_RPY_h
#define _ROS_rosserial_msgs_RPY_h
...
namespace rosserial_msgs
{
  ...
  class RPY : public ros::Msg
  {
    ...
    const char * getType(){ return "rosserial_msgs/RPY"; };
    const char * getMD5(){ return "e16d253ac46e3d525d41cd25c5023ecc"; };
